...
public static class BlazorResourceBuilderExtensions
{
    ...
    /// To use another means to pass service discovery information to the client, use the <see cref="AddWebAssemblyClient{TWebAssemblyProject}(IResourceBuilder{ProjectResource}, string, Action{WebAssemblyProjectBuilderOptions})" /> method
