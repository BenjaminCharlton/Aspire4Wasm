...
/// <summary>
/// A class that can deserialize information to a <see cref="JsonObject"/> from the appsettings.{environment}.json file of the type of project represented by <typeparamref name="TProject"/>.
/// </summary>
...
internal sealed class AppSettingsJsonFileAccessor : IJsonFileAccessor
{
    ...
    /// <param name="environmentName">The name of the hosting environment in which the project of type <typeparamref name="TProject" /> will run.</param>
    ...
    /// <summary>
    /// Deserializes JSON stored in the appsettings.{environment}.json file  of the project represented by <typeparamref name="TProject"/> to an instance of <see cref="JsonObject"/>.
    /// </summary>
    ...
    /// <summary>
    /// Serializes an instance of <see cref="JsonObject" /> to text and saves it in the appsettings.{environment}.json file of the project represented by <typeparamref name="TProject"/>.
    /// </summary>
